...
export declare enum ReportPageInfoResParams {
    limit = "limit",
    hasNextPage = "hasNextPage",
    scrollId = "scrollId"
}
export declare enum ReportNode {
...
export declare abstract class ReportQueryBase extends QueryBase {
    constructor(url: string, auth: Authentication);
}
//# sourceMappingURL=reportQueryBase.d.ts.map